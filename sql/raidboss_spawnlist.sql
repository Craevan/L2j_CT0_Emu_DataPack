...
(
    ...
    `spawn_time`   INT    NOT NULL DEFAULT '36',
    `random_time`  INT    NOT NULL DEFAULT '24',
    `respawn_time` BIGINT NOT NULL DEFAULT '0',
    `currentHp`    decimal         DEFAULT NULL,
    `currentMp`    decimal         DEFAULT NULL,
    PRIMARY KEY (`boss_id`)
);

INSERT INTO `raidboss_spawnlist`
VALUES (25001, -54416, 146480, -2887, 0, 36, 24, 0, 0, 0),      -- Greyclaw Kutus (23)
